      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="../Servicios/Actualizar.php"><i class="fa fa-navicon"></i>Ver servicios</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="../Usuarios/Agregar.php"><i class="fa fa-plus"></i>Agregar cliente</a></li>
