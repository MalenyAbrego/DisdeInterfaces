...
$r = search($id); //Se realiza una busqueda en la base de datos donde se obtienen los atributos del registro con el id ingresado.
  ...
  if(isset($_POST['nombre']) && isset($_POST['descripcion']) && isset($_POST['precio'])){
    updateServicios($_POST['id'],$_POST['nombre'],$_POST['descripcion'],$_POST['precio']);
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#"><i class="fa fa-edit"></i>Editar servicios</a></li>
      </ol>
    </section>
            ...
            <div class="box-body">
              <form method="POST">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="descripcion" rows="3" value="<?php echo($r['descripcion']);?>" placeholder="Descripción del servicio">
                </div>
                <label>Precio</label>
                <div class="input-group">
                  <span class="input-group-addon">$</span>
                  <input type="number" name="precio" value="<?php echo($r['precio']);?>" class="form-control" required>
