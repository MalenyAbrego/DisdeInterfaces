<?php
  ...
  $servicios = get_all_admin();           //Se obtienen todos los registros y se llena el array mediante los usuarios encontrados en la base de datos.
...
<head>
  ...
  <title>Actualizar administradores | Beauty & Seams</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ADMINISTRADORES<a data-toggle="modal" title="Clic aquí para más información" data-target="#myModal"> <i class="fa fa-question-circle"></i></a>
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-users"></i>Administradores</a></li>
        <li class="active treeview"><a href="#"><i class="fa fa-eye"></i>Ver administradores</a></li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php foreach( $servicios as $id => $serv ){ ?>
                  <tr>
                    ...
                    <a href="./delete2.php?id=<?php echo($serv['id']); ?>" title="Eliminar cliente" class="btn btn bg-maroon"><i class="fa fa-trash"></i></a></td>
                  </tr>
                  <?php } ?>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <h4>En esta sección se visualizan los <b>Administradores</b> registrados, los cuales se pueden ordenar de forma ascendente y descendente al hacer clic sobre sobre el siguiente símbolo:
                  <center><img width="50px" src="../img/ordenar.png"></center><br>
                El siguiente botón cumple con la función de editar cualquier administrador seleccionado:</h4>
                <center><img width="40px" src="../img/modificar.png"></center>
                <h4>
                Mientras que el siguiente botón cumple con la función de eliminar cualquier administrador:</h4>
