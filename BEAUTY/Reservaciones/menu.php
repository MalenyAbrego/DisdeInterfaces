    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../Usuarios/Agregar.php"><i class="fa fa-plus"></i>Agregar usuarios</a></li>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="../Reservaciones/Agregar.php"><i class="fa fa-plus"></i>Agregar reservación</a></li>
            <li><a href="../Reservaciones/Actualizar.php"><i class="fa fa-navicon"></i>Ver reservaciones</a></li>
          </ul>
        </li>
      </ul>
    </section>
